...
<head>
    <title>Quotation Inquiries | Mohsin Shaheen Construction Company</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Quotation Inquiries</h4>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="header-title">All Quotation Inquiries</h4>
                                            ...
                                            <tbody>
                                                ...
                                                if ($result) {
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        echo "<td>" . htmlspecialchars($row['quote_type']) . "</td>";
