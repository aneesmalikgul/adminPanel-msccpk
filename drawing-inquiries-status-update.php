...
if (isset($_GET['id'])) {
    ...
    try {
        ...
        if ($resultInquiry->num_rows > 0) {
            ...
            header("Location: drawing-inquiries.php");
            exit();
        }
                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            ...
                            <h2 class="text-center mb-4">Drawing-inquiries Information</h2>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <p style="font-size: 1rem;"><strong>Drawing Type:</strong> <?php echo htmlspecialchars($inquiry['drawing_type']); ?></p>
